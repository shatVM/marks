...
МОЖЛИВІ ПРОБЛЕМИ
    ...
    - в журналах Прізвище та Ім'я мають бути ОДНАКОВІ (не повинно бути по батькові в Classroom) 
    * дана ситуація в процесі вирішення.
...
- приведено формат учнів в Прізвище Ім'я (видаляється По батькові)
